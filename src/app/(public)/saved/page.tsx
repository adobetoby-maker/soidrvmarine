...
import { SavedList } from '@/components/inventory/SavedList'
import { DEALER_INFO } from '@/lib/types'

export const metadata: Metadata = {
  title: 'Saved Units — Southern Idaho RV & Marine',
  description: 'Your saved RVs and boats at Southern Idaho RV & Marine.',
  robots: 'noindex',
}
